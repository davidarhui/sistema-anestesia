...
from PyQt6.QtGui import QPainter, QPen, QColor, QPolygonF, QFont, QPalette, QDesktopServices
...
class RegistroAnestesia(QWidget):
    def __init__(self):
        ...
        layout_encabezado.addWidget(header)
        ...
        for btn in (self.btn_modo_monitor, self.btn_vista_previa):
